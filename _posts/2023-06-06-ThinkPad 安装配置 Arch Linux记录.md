...
目前（2025.11.25），可使用以上政企版激活码成功激活的最高版本为“`12.8.2.21176-1`”，即“`wps-office_12.8.2.21176.AK.preload.sw_amd64.deb`”，该版本的PKGBUILD信息可以在[AUR](https://aur.archlinux.org/cgit/aur.git/commit/?h=wps-office-365&id=f3390947a757f42bfa85ac9d36fec2e15e421ec1)获取。使用如下步骤可成功安装该版本：

```
yay -G piliplus-bin   #获取PKGBUILD
cd piliplus-bin   #进入目录
subl PKGBUILD   #编辑PKGBUILD文件为21176版本的所有信息
makepkg -si   #开始编译安装
```
